...
LowBatteryController.prototype.getStatus = function (battery) {
  ...
  switch (true) {
    case charging: return this.lowbattery.get('charging');
    case value < 6: this.closeApplication(); return this.lowbattery.get(5);
    case value == 6: return this.lowbattery.get(6);
    case value <= 10 && value > 6: return this.lowbattery.get(10);
    case value <= 15 && value > 10: return this.lowbattery.get(15);
    default: return this.lowbattery.get('healthy');
  }
};
